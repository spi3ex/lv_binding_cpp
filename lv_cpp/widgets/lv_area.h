...
#define _lv_grid_align_tYPE_SHIFT    (29U)

#define _lv_grid_align_tYPE_MASK     (3 << _lv_grid_align_tYPE_SHIFT)
#define _lv_grid_align_tYPE(x)       ((x) & _lv_grid_align_tYPE_MASK)  /*Extract type specifiers*/
#define _LV_COORD_PLAIN(x)      ((x) & ~_lv_grid_align_tYPE_MASK) /*Remove type specifiers*/

#define _lv_grid_align_tYPE_PX       (0 << _lv_grid_align_tYPE_SHIFT)
#define _lv_grid_align_tYPE_SPEC     (1 << _lv_grid_align_tYPE_SHIFT)
#define _lv_grid_align_tYPE_PX_NEG   (3 << _lv_grid_align_tYPE_SHIFT)

#define LV_COORD_IS_PX(x)       (_lv_grid_align_tYPE(x) == _lv_grid_align_tYPE_PX || _lv_grid_align_tYPE(x) == _lv_grid_align_tYPE_PX_NEG)
#define LV_COORD_IS_SPEC(x)     (_lv_grid_align_tYPE(x) == _lv_grid_align_tYPE_SPEC)

#define LV_COORD_SET_SPEC(x)    ((x) | _lv_grid_align_tYPE_SPEC)
...
#define LV_COORD_MAX            ((1 << _lv_grid_align_tYPE_SHIFT) - 1)
