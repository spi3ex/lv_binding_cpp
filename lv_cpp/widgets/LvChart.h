...
public:
	...
	LvChart& setRange(lv_chart_axis_t axis, lv_grid_align_t min, lv_grid_align_t max);
	...
	LvChart& setAxisTick(lv_chart_axis_t axis, lv_grid_align_t major_len, lv_grid_align_t minor_len, lv_grid_align_t major_cnt, lv_grid_align_t minor_cnt, bool label_en, lv_grid_align_t draw_size);
	...
	LvChart& setAllValue(lv_chart_series_t *ser, lv_grid_align_t value);
	LvChart& setNextValue(lv_chart_series_t *ser, lv_grid_align_t value);
	LvChart& setNextValue2(lv_chart_series_t *ser, lv_grid_align_t x_value, lv_grid_align_t y_value);
	LvChart& setValueById(lv_chart_series_t *ser, uint16_t id, lv_grid_align_t value);
	LvChart& setValueById2(lv_chart_series_t *ser, uint16_t id, lv_grid_align_t x_value, lv_grid_align_t y_value);
	LvChart& setExtYArray(lv_chart_series_t *ser, int32_t array[]);
	LvChart& setExtXArray(lv_chart_series_t *ser, int32_t array[]);
