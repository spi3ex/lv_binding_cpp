...
LvStyle& LvStyle::setPadAll(lv_grid_align_t value){
	lv_style_set_pad_all(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadHor(lv_grid_align_t value){
	lv_style_set_pad_hor(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadVer(lv_grid_align_t value){
	lv_style_set_pad_ver(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadGap(lv_grid_align_t value){
...
LvStyle& LvStyle::setWidth(lv_grid_align_t value){
	lv_style_set_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setMinWidth(lv_grid_align_t value){
	lv_style_set_min_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setMaxWidth(lv_grid_align_t value){
	lv_style_set_max_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setHeight(lv_grid_align_t value){
	lv_style_set_height(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setMinHeight(lv_grid_align_t value){
	lv_style_set_min_height(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setMaxHeight(lv_grid_align_t value){
	lv_style_set_max_height(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setX(lv_grid_align_t value){
	lv_style_set_x(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setY(lv_grid_align_t value){
...
LvStyle& LvStyle::setTransformWidth(lv_grid_align_t value){
	lv_style_set_transform_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTransformHeight(lv_grid_align_t value){
	lv_style_set_transform_height(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTranslateX(lv_grid_align_t value){
	lv_style_set_translate_x(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTranslateY(lv_grid_align_t value){
	lv_style_set_translate_y(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTransformZoom(lv_grid_align_t value){
	lv_style_set_transform_zoom(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTransformAngle(lv_grid_align_t value){
	lv_style_set_transform_angle(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadTop(lv_grid_align_t value){
	lv_style_set_pad_top(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadBottom(lv_grid_align_t value){
	lv_style_set_pad_bottom(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadLeft(lv_grid_align_t value){
	lv_style_set_pad_left(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadRight(lv_grid_align_t value){
	lv_style_set_pad_right(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadRow(lv_grid_align_t value){
	lv_style_set_pad_row(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setPadColumn(lv_grid_align_t value){
	lv_style_set_pad_column(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setRadius(lv_grid_align_t value){
...
LvStyle& LvStyle::setAnimTime(uint32_t value){
	lv_style_set_anim_duration(cObj.get(),value);
	return *this;
}
...
LvStyle& LvStyle::setBgMainStop(lv_grid_align_t value){
	lv_style_set_bg_main_stop(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setBgGradStop(lv_grid_align_t value){
	lv_style_set_bg_grad_stop(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setBgImgSrc(const void *value){
	lv_style_set_bg_image_src(cObj.get(),value);
	return *this;
}
...
LvStyle& LvStyle::setBgImgRecolor(lv_color_t value){
	lv_style_set_bg_image_recolor(cObj.get(),value);
	return *this;
}
...
LvStyle& LvStyle::setBgImgRecolorOpa(lv_opa_t value){
	lv_style_set_bg_image_recolor_opa(cObj.get(),value);
	return *this;
}
...
LvStyle& LvStyle::setBorderWidth(lv_grid_align_t value){
...
LvStyle& LvStyle::setTextLetterSpace(lv_grid_align_t value){
	lv_style_set_text_letter_space(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setTextLineSpace(lv_grid_align_t value){
...
LvStyle& LvStyle::setImgOpa(lv_opa_t value){
	lv_style_set_image_opa(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setImgRecolor(lv_color_t value){
	lv_style_set_image_recolor(cObj.get(),value);
	return *this;
}
...
LvStyle& LvStyle::setImgRecolorOpa(lv_opa_t value){
	lv_style_set_image_recolor_opa(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setOutlineWidth(lv_grid_align_t value){
...
LvStyle& LvStyle::setOutlinePad(lv_grid_align_t value){
	lv_style_set_outline_pad(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setShadowWidth(lv_grid_align_t value){
	lv_style_set_shadow_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setShadowOfsX(lv_grid_align_t value){
	lv_style_set_shadow_ofs_x(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setShadowOfsY(lv_grid_align_t value){
	lv_style_set_shadow_ofs_y(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setShadowSpread(lv_grid_align_t value){
...
LvStyle& LvStyle::setLineWidth(lv_grid_align_t value){
	lv_style_set_line_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setLineDashWidth(lv_grid_align_t value){
	lv_style_set_line_dash_width(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setLineDashGap(lv_grid_align_t value){
...
LvStyle& LvStyle::setArcWidth(lv_grid_align_t value){
...
LvStyle& LvStyle::setGridCellColumnPos(lv_grid_align_t value){
	lv_style_set_grid_cell_column_pos(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setGridCellColumnSpan(lv_grid_align_t value){
	lv_style_set_grid_cell_column_span(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setGridCellRowPos(lv_grid_align_t value){
	lv_style_set_grid_cell_row_pos(cObj.get(),value);
	return *this;
}
LvStyle& LvStyle::setGridCellRowSpan(lv_grid_align_t value){
